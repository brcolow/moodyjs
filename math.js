...
class Quat extends Float32Array {
  ...
  static rotationTo(out, a, b) {
    ...
    if (dot < -0.999999) {
      tmpVec3[0] = xUnitVec3[1] * a.z - xUnitVec3[2] * a.y
      tmpVec3[1] = xUnitVec3[2] * a.x - xUnitVec3[0] * a.z
      tmpVec3[2] = xUnitVec3[0] * a.y - xUnitVec3[1] * a.x
      if (Vec3.mag(tmpVec3) < 0.000001) {
        tmpVec3[0] = yUnitVec3[1] * a.z - yUnitVec3[2] * a.y
        tmpVec3[1] = yUnitVec3[2] * a.x - yUnitVec3[0] * a.z
        tmpVec3[2] = yUnitVec3[0] * a.y - yUnitVec3[1] * a.x
      }
      const length = Math.sqrt(tmpVec3[0] * tmpVec3[0] + tmpVec3[1] * tmpVec3[1] + tmpVec3[2] * tmpVec3[2])
      tmpVec3[0] = tmpVec3[0] / length
      tmpVec3[1] = tmpVec3[1] / length
      tmpVec3[2] = tmpVec3[2] / length
      ...
      tmpVec3[0] = a.y * b.z - a.z * b.y
      tmpVec3[1] = a.z * b.x - a.x * b.z
      tmpVec3[2] = a.x * b.y - a.y * b.x
      out[0] = tmpVec3[0]
      out[1] = tmpVec3[1]
      out[2] = tmpVec3[2]
      out[3] = 1 + dot
